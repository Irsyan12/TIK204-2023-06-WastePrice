...
$err = "";
$username = $_SESSION['session_usernamepetugas'];
...
$cek_username = mysqli_query($conn, "SELECT * from tb_petugas where username = '$username_baru' AND username != '$username'");
...
if (mysqli_num_rows($cek_username) > 0) {
    ...
    $query = mysqli_query($conn, "UPDATE tb_petugas SET username = '$username_baru' WHERE username = '$username'");
...
if ($no_telepon != "" && $no_telepon != $_SESSION['session_no_telepon']) {
    $query = mysqli_query($conn, "UPDATE tb_petugas SET no_telepon = '$no_telepon' WHERE username = '$username'");
...
$query = mysqli_query($conn, "SELECT * from tb_petugas where username = '$username'");
...
if ($kata_sandi_baru != "") {
    ...
    $query = mysqli_query($conn, "UPDATE tb_petugas SET password = '$kata_sandi_baru' WHERE username = '$username'");
